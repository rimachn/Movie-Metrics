...
## Notes
This project demonstrates how raw user activity logs can be transformed into structured behavioral metrics. The same techniques are widely used in streaming platforms, e-commerce, and digital product analytics.
